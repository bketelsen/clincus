...
Examples:
  # Push file
  clincus file push ./config.json my-container:/workspace/config.json

  # Push directory
  clincus file push -r ./src my-container:/workspace/src`,
...
Example:
  ...
  clincus file pull -r my-container:/root/.claude ./saved-sessions/session-123/`,
	Args: cobra.ExactArgs(2),
	RunE: func(cmd *cobra.Command, args []string) error {
		source := args[0]
		localPath := args[1]
