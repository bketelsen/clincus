...
def test_nested_mounts_rejected(clincus_binary, workspace_dir, tmp_path):
...
def test_config_nested_mounts_rejected(clincus_binary, workspace_dir, tmp_path):
