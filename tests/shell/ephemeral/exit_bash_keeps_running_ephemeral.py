"""
Test for clincus shell - exit bash keeps container running.
...
def test_exit_bash_keeps_container_running(clincus_binary, cleanup_containers, workspace_dir):
    """
    ...
    # Use clincus container delete to clean up
    subprocess.run(
