"""
Test for clincus container stop - fails for nonexistent container.
...
def test_stop_nonexistent(clincus_binary, cleanup_containers):
    """
    ...
    result = subprocess.run(
        [clincus_binary, "container", "stop", nonexistent_name],
        capture_output=True,
        text=True,
        timeout=30,
    )
