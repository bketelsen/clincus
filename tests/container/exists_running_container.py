"""
Test for clincus container exists - returns true for existing container.
...
def test_exists_running_container(clincus_binary, cleanup_containers, workspace_dir):
    """
