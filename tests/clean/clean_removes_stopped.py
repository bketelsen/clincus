"""
Test for clincus clean - removes stopped containers.
...
def test_clean_removes_stopped(clincus_binary, cleanup_containers, workspace_dir):
    """
    Test that clincus clean removes stopped containers.

    Flow:
    1. Launch a container
    2. Stop it (but don't delete)
    3. Run clincus clean --force
