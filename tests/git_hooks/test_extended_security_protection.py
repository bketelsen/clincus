...
class TestGitConfigProtection:
    ...
    def test_git_config_readable(self, clincus_binary, workspace_dir, cleanup_containers):
...
class TestHuskyProtection:
    ...
    def test_husky_readonly_by_default(self, clincus_binary, workspace_dir, cleanup_containers):
    ...
    def test_husky_touch_fails(self, clincus_binary, workspace_dir, cleanup_containers):
    ...
    def test_husky_readable(self, clincus_binary, workspace_dir, cleanup_containers):
    ...
    def test_husky_nonexistent_no_error(self, clincus_binary, workspace_dir, cleanup_containers):
...
class TestVscodeProtection:
    ...
    def test_vscode_readonly_by_default(self, clincus_binary, workspace_dir, cleanup_containers):
    ...
    def test_vscode_readable(self, clincus_binary, workspace_dir, cleanup_containers):
...
class TestSecurityConfigCustomPaths:
    ...
    def test_custom_paths_replace_defaults(self, clincus_binary, workspace_dir, cleanup_containers):
...
class TestSecurityConfigDisableProtection:
    ...
    def test_disable_protection_allows_all(self, clincus_binary, workspace_dir, cleanup_containers):
...
class TestSymlinkSecurity:
    ...
    def test_symlinked_git_dir_handled(self, clincus_binary, workspace_dir, cleanup_containers):
    ...
    def test_git_file_handled(self, clincus_binary, workspace_dir, cleanup_containers):
