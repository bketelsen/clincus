"""
Test for clincus list - does not show IPv4 for stopped containers.
...
def test_list_shows_ipv4_stopped(clincus_binary, cleanup_containers, workspace_dir):
    """
    Test that clincus list does not show IPv4 for stopped containers.
